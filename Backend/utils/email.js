                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                                        <tbody><tr>
                                                            <td class="py-30 px-56" style="padding-top: 30px; padding-bottom: 30px; padding-left: 56px; padding-right: 56px;">
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                            <tbody><tr>
                                                                        <td class="title-48 c-blue1 fw-b a-center" style="font-size:48px; line-height:52px; font-family:'Motiva Sans', Helvetica, Arial, sans-serif; color:var(--primary-color); font-weight:bold; text-align:center;">
                                                                            ${codigo}											
                                                                        </td>
                                                                    </tr>
                                                                </tbody></table>
